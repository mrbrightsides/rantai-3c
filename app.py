...
with st.sidebar:
    ...
    st.sidebar.markdown("""
    **RANTAI 3C Framework** mengintegrasikan teknologi cloud, analytics iklim, dan blockchain untuk menyediakan solusi transparan dan scalable dalam pengukuran dan verifikasi jejak karbon. MVP ini memudahkan organisasi mengunggah data, mengidentifikasi dampak lingkungan, dan menyimpan bukti verifikasi yang terpercaya.  
    
    ---
    #### 🔮 Vision Statement
    
    Menjadi standar global bagi solusi sustainability yang mudah diakses, terpercaya, dan terukur, mendorong kolaborasi luas demi masa depan hijau dan berkelanjutan dengan teknologi Web3.
    ...
    - ⭐ **Star / Fork**: [GitHub repo](https://github.com/mrbrightsides/rantai-3c)
...
# URL Ohara
iframe_url = "https://ohara.ai/mini-apps/2a6c304a-d3bf-45b7-90bf-cdd1346a2b3f"
